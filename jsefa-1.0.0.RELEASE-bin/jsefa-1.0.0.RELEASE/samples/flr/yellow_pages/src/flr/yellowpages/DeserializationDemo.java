...
/**
 * Demo for demonstrating the deserialization of the document "yellow-pages.flr".
 * <p>
...
public final class DeserializationDemo {
    ...
    private Reader createFileReader() {
        return new InputStreamReader(this.getClass().getResourceAsStream("yellow-pages.flr"));
    }
