...
/**
 * Demo for demonstrating the CSV serialization/deserialization performance.
 * 
 * @author Norman Lahme-Huetig
 * 
 */

public class CsvPerformanceDemo extends AbstractPerformanceDemo {
    private static final String FILE_NAME = "jsefa-performance.csv";
    ...
    public static void main(String[] args) {
        CsvPerformanceDemo demo = new CsvPerformanceDemo();
