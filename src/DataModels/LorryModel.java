...
public class LorryModel {
	...
	public String getMax_load_capacity() {
		return max_load_capacity;
	}
	public void setMax_load_capacity(String max_load_capacity) {
	...
	public LorryModel(String vechile_id, String make, String model, String max_load_capacity, String top_speed,
	...
	@CsvField(pos=4)
	private String max_load_capacity="None";
